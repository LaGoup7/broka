...
const SITE  = `${BASE}/broka/`;
const GUIDE = `${BASE}/broka/guide-gratuit-broka.pdf`;
...
<table width="100%" cellpadding="0" cellspacing="0" style="background:#f4ede3;padding:40px 16px;">
  <tr><td align="center">
    <table width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 32px rgba(37,61,13,.13);">
      ...
      <tr><td style="padding:48px 48px 40px;background:#fff;">
        ...
        <h2 style="margin:0 0 28px;font-size:26px;color:#1e3209;font-weight:400;font-style:italic;">${prenom} ${nom}</h2>
  ...
  const farmerHtml = `
    ...
    <table style="border-collapse:collapse;font-family:sans-serif;font-size:15px;">
      <tr><td style="padding:6px 16px 6px 0;color:#666;">Prenom</td><td><b>${prenom}</b></td></tr>
      <tr><td style="padding:6px 16px 6px 0;color:#666;">Nom</td><td><b>${nom}</b></td></tr>
      <tr><td style="padding:6px 16px 6px 0;color:#666;">Email</td><td><a href="mailto:${email}">${email}</a></td></tr>
      <tr><td style="padding:6px 16px 6px 0;color:#666;">Telephone</td><td>${tel || '—'}</td></tr>
    </table>`;
